        ...
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1 dark:bg-gray-900 dark:text-white dark:shadow-emerald-300 ">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 dark:bg-gray-900 dark:text-white ">
            <div className="mt-12 flex flex-col items-center dark:bg-gray-900 dark:text-white ">
              ...
              <div className="w-full flex-1 mt-8 dark:bg-gray-900 dark:text-white">
                ...
                <div className="my-12 border-b text-center dark:bg-gray-900 dark:text-white">
                  <div className=" leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2 dark:bg-gray-900 dark:text-white">
                    Sign in with e-mail
                  </div>
                </div>

                <div className="mx-auto max-w-xs dark:bg-gray-900 dark:text-white ">
                  <label
                    htmlFor="email"
                    className="leading-7 text-xl text-gray-900 dark:bg-gray-900 dark:text-white"
                  >
                    Email
                  </label>
                  <input
          ...
          <div className="flex items-center dark:bg-gray-900 dark:text-white">
            <div className="flex-1 bg-indigo-100 size-full text-center hidden lg:flex dark:bg-gray-900 dark:text-white">
              <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat dark:bg-gray-900 dark:text-white">
                <img
